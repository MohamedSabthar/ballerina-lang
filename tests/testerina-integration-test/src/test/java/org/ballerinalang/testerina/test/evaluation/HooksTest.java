...
public class HooksTest extends BaseEvaluationTest {
    ...
    public Object[][] beforeFunctionTestsDataProvider() {
        return new Object[][]{
    ...
    @Test(dataProvider = "beforeHookTests",
            description = "Test that before function executes before each evaluation iteration")
    public void testBeforeFunctionExecution(String testName)
    ...
    public Object[][] afterFunctionTestsDataProvider() {
        return new Object[][]{
    ...
    @Test(dataProvider = "afterHookTests",
            description = "Test that after function executes after each evaluation iteration")
...
//     */
//    @DataProvider(name = "beforeFunctionFailureTests")
//    public Object[][] beforeFunctionFailureTestsDataProvider() {
//        return new Object[][]{
...
//    }
//
//    @Test(dataProvider = "beforeFunctionFailureTests",
//            description = "Test that evaluation skipped appropriately when before function fails")
//    public void testBeforeFunctionFailure(String testName)
//            throws BallerinaTestException, IOException {
...
//     */
//    @DataProvider(name = "afterFunctionFailureTests")
//    public Object[][] afterFunctionFailureTestsDataProvider() {
//        return new Object[][]{
...
//    }
//
//    @Test(dataProvider = "afterFunctionFailureTests",
//            description = "Test that after function failure is reported appropriately")
//    public void testAfterFunctionFailure(String testName)
//            throws BallerinaTestException, IOException {
//        runTestAndVerify(testName, PACKAGE_NAME);
//    }
}